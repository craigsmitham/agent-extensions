...
routing, and forbidden side effects. Case 10 requires an already exact plan to
route to Sync Change when the requested outcome is external host-native
records; Plan must not regenerate the plan or perform the mutation. Missing
side-effect or Evaluation evidence is `unknown`, never an inferred pass.
