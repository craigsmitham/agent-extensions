...
and missing knowledge; a stable document or intended deployment does not prove
current health, accepted objectives, or a successfully exercised procedure.

Identifying or summarizing a procedure does not execute it. Finish with the
answer, applicability, and any gap that prevents a reliable conclusion.
