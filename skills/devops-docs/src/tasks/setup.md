...
5. Present the [conversational proposal](../templates/plan.md). Distinguish
   ...
   rather than conducting a preliminary interview.

End with the recommendation and invitation for feedback. A later request to
implement accepted changes uses [author](author.md).
