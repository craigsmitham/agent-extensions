...
| [software-architecture](.axm/extensions/@craigsmitham/knowledge/software-architecture/src/index.md) | Human-first software architecture guidance and the required OKF profile for durable system meaning, product quality requirements, lifecycle, boundaries, and selected views |
