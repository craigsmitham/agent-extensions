...
sources:
  - id: effect-errors
    resource: https://github.com/Effect-TS/effect/blob/effect%404.0.0-rc.115/ai-docs/src/01_effect/04_errors/01_error-handling.ts
    title: Effect 4.0.0-rc.115 error handling basics
  - id: effect-cause
    resource: https://github.com/Effect-TS/effect/blob/effect%404.0.0-rc.115/packages/effect/src/Cause.ts
    title: Effect 4.0.0-rc.115 Cause source
...
- [Error handling basics](https://github.com/Effect-TS/effect/blob/effect%404.0.0-rc.115/ai-docs/src/01_effect/04_errors/01_error-handling.ts)
- [Cause source](https://github.com/Effect-TS/effect/blob/effect%404.0.0-rc.115/packages/effect/src/Cause.ts)
