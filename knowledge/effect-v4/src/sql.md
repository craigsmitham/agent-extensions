...
sources:
  - id: effect-sql
    resource: https://github.com/Effect-TS/effect/blob/effect%404.0.0-rc.115/ai-docs/src/40_sql/10_basics.ts
    title: Effect 4.0.0-rc.115 SQL basics
  - id: effect-sql-client
    resource: https://github.com/Effect-TS/effect/blob/effect%404.0.0-rc.115/packages/effect/src/unstable/sql/SqlClient.ts
    title: Effect 4.0.0-rc.115 SqlClient source
  - id: effect-sql-error
    resource: https://github.com/Effect-TS/effect/blob/effect%404.0.0-rc.115/packages/effect/src/unstable/sql/SqlError.ts
    title: Effect 4.0.0-rc.115 SqlError source
  - id: effect-pg-client
    resource: https://github.com/Effect-TS/effect/blob/effect%404.0.0-rc.115/packages/sql/pg/src/PgClient.ts
    title: Effect 4.0.0-rc.115 native PostgreSQL client
  - id: effect-pg-types
    resource: https://github.com/Effect-TS/effect/blob/effect%404.0.0-rc.115/packages/sql/pg/src/PgTypes.ts
    title: Effect 4.0.0-rc.115 PostgreSQL binary codecs
...
- [SQL basics](https://github.com/Effect-TS/effect/blob/effect%404.0.0-rc.115/ai-docs/src/40_sql/10_basics.ts)
- [SqlClient source](https://github.com/Effect-TS/effect/blob/effect%404.0.0-rc.115/packages/effect/src/unstable/sql/SqlClient.ts)
- [SqlError source](https://github.com/Effect-TS/effect/blob/effect%404.0.0-rc.115/packages/effect/src/unstable/sql/SqlError.ts)
- [Native PostgreSQL client and pool configuration](https://github.com/Effect-TS/effect/blob/effect%404.0.0-rc.115/packages/sql/pg/src/PgClient.ts)
- [PostgreSQL parameter and result codecs](https://github.com/Effect-TS/effect/blob/effect%404.0.0-rc.115/packages/sql/pg/src/PgTypes.ts)
