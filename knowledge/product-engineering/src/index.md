...
Done, domain-driven design, and Drucker's organizational renewal. A section with
no concepts still carries its
...
| --- | --- |
| [Foundations](foundations/) | Jobs to Be Done, domain-driven design, and Drucker's organizational renewal; shared conceptual context for the lifecycle |
