...
- **Draft**: Added [ISO/IEC/IEEE 29148: requirement and requirement-set quality](foundations/iso-iec-ieee-29148-requirement-quality.md), grounded in a licensed copy of the 2018 second edition and cited by clause without reproducing its text. Explained the requirement construct and keyword convention, the nine individual and five set characteristics with their clarifying notes, language criteria, attributes, verification and validation, and the full, process, information-item, and tailored conformance claims. Compared the standard with this bundle's requirements practice, recording the characteristics the bundle does not name (correct, conforming, comprehensible, able to be validated), the qualities it adds (traceable, modifiable, balanced), and differences in completeness, identity, classification, and binding language. Applied the characteristics to Northbank's `NB-REPLACE-01` and its set, added a Foundations requirement-quality group, and linked the authoring and review concepts back to the explanation.

## 2026-09-11

- **Draft**: Added [Service blueprinting](foundations/service-blueprinting.md), grounded in Shostack's 1984 Harvard Business Review article and Bitner, Ostrom, and Morgan's 2008 California Management Review account, with practitioner definitions, a digital template, facilitation guidance, a tool-oriented description, and Kalbach's alignment-diagram treatment. Developed the five components, the three named lines, vertical-slice and line-crossing reading, and construction order through a scoped Northbank confirmation scenario using the case's request, offer, hold, reservation, allocation, and handover vocabulary. Separated Shostack's original four design steps and fail points from the later onstage/backstage and physical-evidence additions, recorded that the 1984 article does not name a line of visibility, and marked secondary origin dating as unsettled. Distinguished blueprints from journey maps, job maps, process notations, value stream maps, and Wardley maps; established that a blueprint supplies a named visibility classification where a value chain expresses visibility as position without bands, and that neither vertical position determines importance or sourcing. Added a Foundations group for service delivery and visibility, updated the bundle's foundation theme list, and connected Jobs to Be Done and Wardley mapping in both directions.

## 2026-09-09

- **Shared case**: Established [Northbank Equipment](northbank-equipment.md) as the fictional cross-lifecycle context, with scoped episodes, vocabulary, and numerical exhibits. Added worked [commitment requirements](solution/requirements/authoring/northbank-commitment-requirements.md), [allocation change](engineering/northbank-allocation-change.md), [engineering-system change](engineering/northbank-engineering-system.md), and [receipt records](delivery/work-items/northbank-receipt-incident.md). Connected all twenty foundation explainers and selected lifecycle guides, added an engineering Wardley view, and preserved question-led discovery, source distinctions, and the limits of unwritten general guidance.

- **Discovery follow-up**: Reviewed the ten recent design, project-management, measurement, and maintenance explainers against the existing navigation. Grouped foundation entry choices, split the behavior reading route into explicit exploration, coherent-behavior, and project-evidence branches, and replaced repeated root-level inventories with routes to the catalog. Added contextual return links for Buxton and Brooks, practical connections for service levels and quantitative requirements, links between service signals and maintenance judgment, and project-evidence continuations from work-item verification and requirement change. Preserved canonical paths, source interpretations, and the distinction between shared explanations and unwritten applied guidance.

- **Draft**: Added [Maintenance strategies and their relationships](foundations/maintenance-strategies.md), [Run-to-failure maintenance: deliberate acceptance and reactive repair](foundations/run-to-failure-maintenance.md), [Preventive maintenance: intervention by time and use](foundations/preventive-maintenance.md), and [Condition-based and predictive maintenance: observation, forecasts, and intervention](foundations/condition-based-and-predictive-maintenance.md). Researched NASA and DOE maintenance guidance, Parnas's software-aging paper, IBM's condition-based terminology and software-aging research abstract, Google SRE monitoring, and PostgreSQL vacuuming documentation. Developed original rental-service examples, distinguished structural aging from runtime deterioration, and made the trigger, evidence, consequence, and intervention relationships explicit. Updated foundation and maintenance discovery, the continuity reading route, and the existing maintenance explanation's treatment of software wear.

- **Draft**: Added [Key performance indicators: measures, targets, and decisions](foundations/key-performance-indicators.md) and [SLIs, SLOs, and SLAs: service measures, objectives, and agreements](foundations/service-level-indicators-objectives-and-agreements.md) in Foundations. Grounded the explanations in public service-measurement guidance, the HEART paper, and Google SRE sources, with original rental-service applications. Distinguished objectives, metrics, targets, decision roles, Alleman's measure types, and service agreements; developed measurement boundaries, error-budget arithmetic, and interpretation limits. Connected Foundations, Operations, outcome evidence, Alleman, reading routes, and package discovery.

- **Draft**: Added [Glen Alleman's performance-based project management: capabilities, credible plans, and evidence of progress](foundations/alleman-performance-based-project-management.md), grounded in his five-principle account, planning and risk explanations, and coauthored baseline paper. Developed capability, resource, risk, accomplishment, and forecast judgments through a fictional rental-confirmation project. Distinguished principles, practices, and processes; baseline, actuals, forecast, and authorized revision; and earned value from product benefit. Connected requirements and verification, clarified relationships with Shape Up, and updated foundation, delivery, reading-route, and package discovery.

- **Draft**: Added [Shape Up: Ryan Singer's approach to shaping, betting, and building](foundations/shape-up.md), grounded in Singer's online book. Developed appetite, shaping, pitches, betting, team ownership, scopes, progress, and finishing through a fictional rental confirmation project. Distinguished investment from estimation, proposals from commitments, shipping from outcomes, and Shape Up's assignment boundary from Cagan's. Covered team-size and new-product adaptations, connected solution and delivery discovery and the behavior reading route, and refreshed package coverage summaries.

- **Draft**: Added [Bill Buxton's approach to design: sketching, alternatives, and experience](foundations/buxton-design.md), grounded in the workbook authors' teaching materials, Buxton's public talk and chapter preview, and two coauthored studies. Developed exploration, representation, comparison, and focused evaluation through an original rental-booking example. Distinguished research findings from application judgments, retained the overview's design authority, and connected Foundations, solution discovery, the behavior reading route, and package coverage summaries.

- **Draft**: Added [Fred Brooks on the architect's role: conceptual integrity and responsibility to the user](foundations/brooks-architect-role.md), grounded in chapters 4–6 and the 1995 retrospective of *The Mythical Man-Month*, plus his 2010 design interview. Used an original rental example to connect public behavior, authority, implementation feedback, specification, and change. Distinguished Brooks's organizational argument from a proposed interpretation for collaborative teams and DDD model boundaries. Updated Foundations, solution and engineering discovery, the behavior reading route, and package coverage summaries.

- **Draft**: Added [Drucker's theory of the business](foundations/drucker-theory-of-the-business.md), grounded in the 1994 article and Drucker Institute adaptation. Developed its assumptions, validity requirements, obsolescence, and continuing examination through the fictional rental service. Connected business assumptions to the strategy comparison and renewal, and updated foundations, strategy, reading routes, and bundle discovery.

- **Discovery and comprehension**: Added [Reading product engineering](reading-product-engineering.md) with four optional question-led routes and continuations into the practical subtrees. Added [Strategy perspectives and their relationships](foundations/strategy-perspectives.md) as the shared comparative account, using the existing rental example and preserving differences among approaches. Reworked foundation selection, connected all lifecycle and major subtree entry points, added contextual and return links between foundations and applied guidance, and consolidated repeated strategy comparisons. Documented discovery maintenance in the package README; retained canonical paths and explicit coverage gaps.

- **Draft**: Added [Value-based strategy: Oberholzer-Gee's approach to creating and sharing value](foundations/value-based-strategy.md), grounded in his interviews and HBS explanations. Developed the value stick, numerical allocation example, three sources of value, reinforcing mechanisms, value maps, capture, and model limits through the fictional rental service. Preserved differences from Playing to Win and linked Cagan. Moved the value-stick explanation out of the strategy index into the tagged concept, retaining its discovery heading, and updated bundle authority and navigation descriptions.

- **Draft**: Added [Playing to Win: Lafley and Martin's approach to strategy](foundations/playing-to-win.md), grounded in the authors' public accounts. Developed the five choices, their coherence, defensibility, supporting systems, and testing through two fictional rental-service strategies. Distinguished the cascade from the choice-making process and identified Martin's later refinements. Connected Cagan's account in both directions and updated Foundations, strategy, and bundle discovery.

- **Draft**: Added [Marty Cagan's product strategy](foundations/cagan-product-strategy.md), grounded in his 2020 SVPG strategy series and strategic-context article. Connected focus, insights, actions, and management through an illustrative rental-service example; distinguished strategic hypotheses, candidate solutions, and outcome evidence. Mapped Cagan's terminology to this bundle's lifecycle and updated Foundations, strategy, problem selection, and bundle discovery.
