...
sources:
  - id: strategy-value-creation
    resource: ../strategy/value-creation-and-capture.md
    title: Where to play — Value creation and capture
generated:
  by: claude/opus-5
...
capabilities, and value creation.[^strategy-value-creation] This section
applies those choices by forming and testing product meaning.
...
[^strategy-value-creation]: [Value creation and capture](../strategy/value-creation-and-capture.md)
    explains the broader value creation system in which product offerings
    participate.
