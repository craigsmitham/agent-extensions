...
tags: [workflow, automation, orchestration, ci-cd, explanation, pe-delivery]
status: draft
sources:
...
Every pattern and practice in this subtree discusses these consequences in its
...
observable execution it remains implementation detail. Likewise, this subtree
...
defined execution structure and durable lifecycle; agent engineering, the design
of goal-directed model-driven systems and the subject of the separate
`agent-engineering` bundle, owns model-directed choice, replanning, capability
policy, delegation, and stopping inside an agent boundary. See [Agents and agentic workflows](agents-and-agentic-workflows.md).
