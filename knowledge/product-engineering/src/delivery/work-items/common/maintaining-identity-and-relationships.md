...
tags: [work-item, identity, relationships, duplicate, merge, split, supersession, reopening, regression, pe-delivery]
...
Requirements use the same vocabulary against a different artifact, covered by
[Maintaining requirement identity and
lineage](../../../solution/requirements/lifecycle/maintaining-requirement-identity-and-lineage.md).
Keep the two lineages separate. Superseding the requirement a Defect Report
cites does not supersede the report, and splitting a Change does not split the
