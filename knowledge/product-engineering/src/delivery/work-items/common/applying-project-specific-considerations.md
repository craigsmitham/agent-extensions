...
tags: [work-item, repository-instructions, local-policy, security, compatibility, accessibility, migration, operations, pe-delivery]
...
This guide covers work items only. Its twin, for the terminology, authority,
rigor, and lifecycle rules a project layers over the portable requirements
model, is [Applying project-specific requirements
policy](../../../solution/requirements/adaptation/applying-project-specific-requirements-policy.md).
Read the guide for the artifact in hand; neither overrides the other.
