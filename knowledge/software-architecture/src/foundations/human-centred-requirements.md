...
A human-centred requirement belongs in the architecture corpus when its
...
requirements](../guides/documenting-usability-requirements.md) when an outcome
of use is primary. Use [Documenting human-factors
requirements](../guides/documenting-human-factors-requirements.md) when human
