...
tags: [testing, executable-specifications, specification-by-example, bdd, acceptance-testing, gherkin, living-documentation, test-architecture, characterization-testing, spec-driven-development]
status: stable
sources:
