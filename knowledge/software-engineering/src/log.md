...
- **Defect reports**: Reframed defect guidance around reported anomalies,
  ...
  defect reports](work-items/failures-defects-and-defect-reports.md) and the
  guide to [Recording defect reports](work-items/recording-defect-reports.md).
- **Feature requests**: Reframed feature-request guidance around source
  occurrences, normalized requests, requirements, and delivery authority;
  renamed the explainer to [Feature requests, requirements, and delivery
  work](work-items/feature-requests-requirements-and-delivery-work.md) and the
  guide to [Recording feature requests](work-items/recording-feature-requests.md).
...
- **Architecture documentation**: Added the candidate Just Enough Architecture
  Docs pattern and Applying Just Enough Architecture Docs guide for
...
- **Creation**: Established the bundle with architecture guidance and
  [YAGNI and speculative complexity](design-and-change/yagni-and-speculative-complexity.md).
