...
description: Use when a condition must remain true across a declared observation boundary; classify the invariant, admit accepted preservation obligations as Requirements, and connect them to architecture, enforcement, and evidence.
...
enforcement](/architecture/requirements/invariants-and-enforcement.md).
