...
description: Use when an accepted system, product, service, or data quality outcome must be assessable; engineer and document one quality Requirement using the unified model and applicable classification.
