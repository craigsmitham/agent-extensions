...
- [Domain-driven design](/architecture/domains/domain-driven-design.md) explains domain meaning,
  language, subdomains, bounded contexts, and authority boundaries.
- [Wardley mapping](/intent/wardley-mapping.md) relates user need, dependency,
...
- [Goal-oriented behavior and use cases](/intent/goal-oriented-behavior.md) connects
  actor goals and selected scenarios to structural responsibilities.
- [Capabilities in software
  architecture](/architecture/capabilities/capabilities.md) describes outcomes,
  recognizable behavior, and actor-facing interaction points.
- The [Gen Stack application profile for OKF
  v0.2](/profile/gen-stack-application-profile.md) defines canonical C4 view
  types and paths, while the [Gen Stack vocabulary and relationship
  model](/glossary.md) defines their semantics and relationship boundaries.
...
[containers](/architecture/structure/documenting-c4-containers.md),
[components](/architecture/structure/documenting-c4-components.md), and
[views](/architecture/structure/documenting-c4-views.md) when authoring one artifact.
