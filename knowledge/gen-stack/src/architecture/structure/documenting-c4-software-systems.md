...
Create one `C4 Software System` concept under `architecture/structure/systems/` for the
...
2. Create its canonical file using the `C4 Software System` type and common
   fields from the [application profile](/profile/gen-stack-application-profile.md#c4-software-system).
