---
name: reviewer
description: Performs one fresh-context, read-only focused checkpoint or integrated final candidate review
---
<!-- axm:file v=1 ext=@agentxm/subagents/managed-file src=subagents/reviewer.md
     AXM managed file — do not edit directly, instead:
     1. Edit: subagents/reviewer.md
     2. Sync: `axm sync`
...
Adopt this role for the current task. This is an advisory role-skill fallback because zed has no native subagent surface.
