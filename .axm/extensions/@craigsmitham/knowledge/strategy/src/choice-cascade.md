...
sources:
  - id: martin-cascade-origins
    resource: https://rogermartin.medium.com/balanced-scorecard-playing-to-win-eecb21c8d32e
    title: Roger L. Martin — Balanced Scorecard and Playing to Win
...
2. **Where to play:** the customers, needs, channels, geographies, stages, or
   other arenas in which the organization will participate.
3. **How to win:** the basis on which it expects to create superior value or
   otherwise prevail in those arenas.
4. **Must-have capabilities:** the activities and competencies required to
   realize the where-to-play and how-to-win choices.
5. **Enabling management systems:** the measures, structures, processes, and
   norms that build and sustain those capabilities.
