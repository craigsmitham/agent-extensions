...
description: Choosing Deferred, Queue, PubSub, Ref, and Semaphore; use for homegrown locks, shared mutable state, event emitters, polling flags, or admission control.
tags: [effect, effect-v4, deferred, queue, pubsub, ref, semaphore, backpressure, coordination]
status: stable
sources:
  - id: origin-skill
    ...
    title: effect-v4-async-coordination skill 0.1.0 (retired into this bundle)
generated:
  by: claude/opus-5
