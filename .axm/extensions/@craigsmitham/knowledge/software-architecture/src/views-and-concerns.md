...
a viewpoint establishes the conventions used to construct that view.[^views]
...
[^views]: The ISO 42010 conceptual model relates stakeholders and concerns to
    viewpoints, views, and architecture models.
