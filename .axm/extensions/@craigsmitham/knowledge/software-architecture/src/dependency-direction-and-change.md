...
steps.[^parnas] The enduring principle is to hide volatile knowledge behind a
...
[^parnas]: Parnas compares decomposition by processing step with decomposition
    around information-hiding modules and evaluates their effects on change and
    comprehensibility.
