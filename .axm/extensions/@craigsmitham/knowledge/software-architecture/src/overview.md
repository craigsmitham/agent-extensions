...
views.[^iso] The useful corpus is therefore not the largest one; it is the one
that exposes the decisions needed by its actual readers.

[^iso]: ISO/IEC/IEEE 42010 defines requirements for expressing architecture
    descriptions across software, systems, enterprises, and related entities.
