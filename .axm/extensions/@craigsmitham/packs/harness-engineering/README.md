...
| Extension | Role |
| --- | --- |
| `@craigsmitham/knowledge/harness-engineering` | System-level concepts for runtimes, interfaces, state, feedback, authority, containment, agent legibility, and evaluation |
| `@craigsmitham/knowledge/context-engineering` | Context selection, authority, routing, retrieval, memory, compaction, and lifecycle |
